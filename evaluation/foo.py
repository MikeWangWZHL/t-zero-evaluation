...
def main():
    ...
    for template_name in template_names:
        ...
        template_output_name = template_name.replace(" ","_")
        os.makedirs(os.path.join(args.output_dir, template_output_name), exist_ok=True)
        if accelerator.is_main_process:
            if args.output_dir is not None:
                with open(os.path.join(args.output_dir, template_output_name, "results.json"), "w") as f:
